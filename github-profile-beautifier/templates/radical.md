...
[![Typing SVG](https://readme-typing-svg.demolab.com/?lines={{typing_lines}}&font=Fira+Code&size=20&color=F7587A&vCenter=true&width=500&height=50)](https://github.com/DenverCoder1/readme-typing-svg)
...
{{#if website}}
[![Website](https://img.shields.io/badge/Website-{{#if website_name}}{{website_name}}{{else}}Personal Website{{/if}}-0077B5?style=for-the-badge&logo=googlechrome&logoColor=white)]({{website}})
{{/if}}
{{#if blog}}
[![Blog](https://img.shields.io/badge/Blog-{{#if blog_name}}{{blog_name}}{{else}}Tech Blog{{/if}}-00A98F?style=for-the-badge&logo=blogger&logoColor=white)]({{blog}})
{{/if}}
{{#if email}}
[![Email](https://img.shields.io/badge/Email-Send%20Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:{{email}})
{{/if}}
{{#if linkedin}}
