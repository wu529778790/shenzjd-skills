...
{{#if website}}
[![Website](https://img.shields.io/badge/Website-{{#if website_name}}{{website_name}}{{else}}个人网站{{/if}}-0077B5?style=for-the-badge&logo=googlechrome&logoColor=white)]({{website}})
{{/if}}
{{#if blog}}
[![Blog](https://img.shields.io/badge/Blog-{{#if blog_name}}{{blog_name}}{{else}}技术博客{{/if}}-00A98F?style=for-the-badge&logo=blogger&logoColor=white)]({{blog}})
{{/if}}
{{#if email}}
