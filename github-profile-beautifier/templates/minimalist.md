...
{{#if website}}
[![Website](https://img.shields.io/badge/Website-{{#if website_name}}{{website_name}}{{else}}Personal Website{{/if}}-0077B5?style=flat-square&logo=googlechrome&logoColor=white)]({{website}})
{{/if}}
{{#if blog}}
[![Blog](https://img.shields.io/badge/Blog-{{#if blog_name}}{{blog_name}}{{else}}Tech Blog{{/if}}-00A98F?style=flat-square&logo=blogger&logoColor=white)]({{blog}})
{{/if}}
{{#if email}}
[![Email](https://img.shields.io/badge/Email-Send%20Email-D14836?style=flat-square&logo=gmail&logoColor=white)](mailto:{{email}})
{{/if}}
{{#if linkedin}}
