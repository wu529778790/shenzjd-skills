...
| ⚡ **hunyuan-image** | Tencent Hunyuan 3.0 — **FREE 100K images** via the WeChat 小程序成长计划 incentive pack: text-to-image + image-to-image | `generate an image with hunyuan` |
...
Inspiration → freeimg AI Generation → 2K Images
                                              ↘
                       WeChat ecosystem → hunyuan-image (FREE 100K images, t2i + i2i)
```
...
> ⚡ **hunyuan-image** companion web app: [freeimg.shenzjd.com/hunyuan](https://freeimg.shenzjd.com/hunyuan) — visual Hunyuan studio (text-to-image + reference-image i2i) with a **step-by-step illustrated tutorial** for claiming the free WeChat 小程序成长计划 incentive pack (**100,000 free AI images + 1B tokens**, 6-month validity). Same BYOK credentials as the skill.
